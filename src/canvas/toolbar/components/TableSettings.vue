                   ...
                   <table  class="MatcToolbarTableSettingsTable">
                      ...
                      <tbody>
                           ...
                           <tr class="MatcFormRow" v-for="(action, i) in props.tableActions" :key="i"
                               ...
                               @dragstart="onActionDragStart($event, i)"
                               @dragover="onActionDragOver($event, i)"
                               @drop="onActionDrop($event, i)"
                           >
                               <td>
                           ...
                           <tr class="MatcFormRow">
                               <td>
                                   <span class="MatcButton" @click="addAction">Add Action</span>                                   
                               </td>
                               <td></td>
                               <td></td>
                               <td></td>
                  ...
                  <table  class="MatcToolbarTableSettingsTable">
                      <thead>
                       ...
                       <tbody>
                           ...
                           <tr>
                               <td>
                                   <span class="MatcButton" @click="addColumn">Add Column</span>
                               </td>
                               <td></td>
                               <td></td>
                               <td></td>
