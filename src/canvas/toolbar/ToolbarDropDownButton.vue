...
export default {
    ...
    components: {},
    methods: {
        setLabelPostfix:function(postfix){
		...
		showInputDialog:function(o, li,e){
			this.stopEvent(e);
			var dialog = o.dialog;
		...
		onDialogValueChanged:function(input, o){
		...
		setDialogValue:function(key, value){
			if(!this.dialogValues){
				this.dialogValues ={};
			}
		...
		invokeCallback:function(callback, e){
			this.stopEvent(e);
			this.hideDropDown();
			callback(e);
		},
		
		invokeCallback2:function(callback, e){
			this.stopEvent(e);
			callback(e);
		},
