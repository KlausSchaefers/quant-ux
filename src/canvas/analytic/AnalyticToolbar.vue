    ...
    methods: {
		...
		showWidgetProperties(model){
			...
			if(data[model.id]){				
				...
				this.setInnerHTML(this.widgetDiscoverSTDLabel, "+/-" + Math.round(widgetData.discoverTimeStd / 1000) + "s")
				this.setInnerHTML(this.widgetDiscoverLabel, Math.round(widgetData.discoverTimeAbs / 1000) + "s");				
			}
		},
