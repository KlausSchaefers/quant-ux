export let texts = [
    {
        ...
        "body": `
            ...
            To learn more, use the navigation on the right side, or the search to find help.
        `,
        "paragraphs": [
                {
                    "id": "default.into",
                    ...
                    "body": `
                        ...
                        This means users can toggle a checkbox or enter data into a text field.<br>
                ...
                },
                {
                    ...
                    "title": "Screens",
                    "body": `
                        A screen is the canvas where you can place widgets. To create a screen press <strong>S</strong>
                        or click the <span class=" mdi mdi-cellphone"/> icon. You can place the screen freely 
                        on the canvas.<br>
                        Once you have placed the screen, click on it to select it. On the the right property panel, you can
                        now configure the screen name, the background (color or image). <br>
                        You can also set a screen to be an overlay. This means, that the screen will be rendered on top of
                        another screens. This is usefull, of you want to build a model dialog.
                    `
                },
                {
                    "id": "default.widgets",
                    ...
                    "body": `
                        ...
                        W or selecting <span class="mdi mdi-puzzle"/> icon. To create the most common widgets,
                ...
                },
                {
                    ...
                    "title": "Links",
                    "body": `
                        To create a screen transition, you have to link a widget or screen to another screen. 
