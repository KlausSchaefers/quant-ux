...
export default {
    ...
    methods: {
		...
		_onOpenFile:function(e){
			console.debug("_onOpenFile", e);
			e.stopPropagation();
			this._lastMouseEvent = e;
		},
		
		setUploadCallBack:function(fct){
